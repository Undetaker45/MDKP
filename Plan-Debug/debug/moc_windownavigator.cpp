...
#include <memory>
#include "../../Plan/windownavigator.h"
...
namespace {
struct qt_meta_stringdata_WindowNavigator_t {
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_WindowNavigator_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_WindowNavigator_t qt_meta_stringdata_WindowNavigator = {
    {
        QT_MOC_LITERAL(0, 15),  // "WindowNavigator"
        QT_MOC_LITERAL(16, 19),  // "slotLoginSuccessful"
        QT_MOC_LITERAL(36, 0),  // ""
        QT_MOC_LITERAL(37, 4),  // "User"
        QT_MOC_LITERAL(42, 4),  // "user"
        QT_MOC_LITERAL(47, 10)   // "slotLogout"
    },
    "WindowNavigator",
    "slotLoginSuccessful",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_WindowNavigator[] = {
...
Q_CONSTINIT const QMetaObject WindowNavigator::staticMetaObject = { {
    ...
    qt_meta_stringdata_WindowNavigator.offsetsAndSizes,
    qt_meta_data_WindowNavigator,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_WindowNavigator_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<WindowNavigator, std::true_type>,
        // method 'slotLoginSuccessful'
...
void WindowNavigator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->slotLoginSuccessful((*reinterpret_cast< std::add_pointer_t<User>>(_a[1]))); break;
...
void *WindowNavigator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_WindowNavigator.stringdata0))
